...
public class MyMainActivity extends ActionBarActivity{
    ...
    public void UstNow(View view) { Intent ito=new Intent(this, UstNow.class);
        startActivity(ito); }
    public void UstThen(View view) {
        Intent intent=new Intent(this, UstThen.class);
